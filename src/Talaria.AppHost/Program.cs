...
var tempo = builder.AddContainer("tempo", "grafana/tempo")
    ...
    .WithBindMount("grafana-config/tempo.yml", "/etc/tempo.yaml", isReadOnly: true)
...
var grafana = builder.AddContainer("grafana", "grafana/grafana")
    ...
    .WithBindMount("grafana-config/datasources", "/etc/grafana/provisioning/datasources", isReadOnly: true)
    .WithBindMount("grafana-config/dashboards", "/etc/grafana/provisioning/dashboards", isReadOnly: true);
// -----------------------

...
/// <see cref="TalariaListener"/>. All consumption orchestration (topic handlers, saga
/// steps, deferral sweeper, and outbox relay) lives in the listener; this type is a
/// thin shell so existing DI/ASP.NET Core apps can keep using AddHostedService.
/// </summary>
